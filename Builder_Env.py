...
class Structure_Builder(RealExpEnv):
    ...
    def reset(self, final_destination_absolute_nm, offset_nm, len_nm):
        self.len = 0
        self.atom_absolute_nm = self.scan_atom(offset_nm, len_nm)
        ...
        info = {'start_absolute_nm':self.atom_start_absolute_nm, 'goal_absolute_nm':self.destination_absolute_nm,
                'start_absolute_nm_f':self.atom_absolute_nm_f, 'start_absolute_nm_b':self.atom_absolute_nm_b}
    ...
    def step(self, action):
        ...
        if self.len == self.max_len:
            ...
            if jump:
                ...
                if (dist_start/self.goal_nm) > 1.5 or self.dist_destination < 0.14:
                    done = True
    ...
    def scan_atom(self, offset_nm = None, len_nm = None):
    ...
    def pull_atom(self, start, end):
        print('pulling atom')
        self.createc_controller.lat_manipulation(start[0], start[1], end[0], end[1], 10, 60000, self.offset_nm, self.len_nm)
